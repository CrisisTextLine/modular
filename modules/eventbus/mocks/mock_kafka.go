...
// Source: github.com/IBM/sarama (interfaces: SyncProducer,ConsumerGroup)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_kafka.go -package=mocks github.com/IBM/sarama SyncProducer,ConsumerGroup
//
